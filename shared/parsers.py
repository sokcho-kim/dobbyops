...
class ParserFactory:
    ...
    @staticmethod
    def create(parser_type: str = "upstage", api_key: Optional[str] = None, project: str = "default") -> BaseParser:
        """
        파서 인스턴스 생성
        ...
        if parser_type == "upstage":
            ...
            return UpstageParser(api_key, project)

        raise ValueError(f"Unknown parser type: {parser_type}")


# 편의 함수
def create_parser(parser_type: str = "upstage", project: str = "default") -> BaseParser:
    """
    파서 생성 단축 함수
    ...
    Returns:
        파서 인스턴스
    """
    return ParserFactory.create(parser_type, project=project)
